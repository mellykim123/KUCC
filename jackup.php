      ...
      <div class="total_chart_table">
        <table>
          ...
          
          {
            ...
            echo "<td><span>{$Today_def[$j]}</span><span class='Today_def_change_{$j}'>{$Today_def_change[$j]}</span></td>";
          ...
          $i = 0;
          echo"<script>let Today_def_arr = [];</script>";
          while($i < count($gubun_arr)){
          
            echo "<script>Today_def_arr.push({$Today_def[$i]})</script>";
            $i++;
          }
          ?>
